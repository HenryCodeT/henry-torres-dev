...
export const skillMountain: SkillLayer[] = [
  {
    ...
    skills: [
      ...
      },
      {
        ...
        icon: '🟢',
        color: '#339933',
        description: 'ES6+ features, best practices, performance',
      }
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        icon: '🟢',
        color: '#339933',
        description: 'ASP.NET, Entity Framework, LINQ, SQL Server',
      },
      {
        name: 'C#',
        level: 4,
        icon: '🟢',
        color: '#339933',
        description: 'C# 10, LINQ, SQL Server',
      }
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        icon: '🤖',
        color: '#10A37F',
        description: 'GPT models integration, embeddings, chat completions',
      },
      {
        name: 'Anthropic',
        level: 3,
        icon: '🧠',
        color: '#D97757',
        description: 'Claude API, prompt engineering, AI applications',
      },
      {
        name: 'Gemini',
        level: 3,
        icon: '✨',
        color: '#4285F4',
        description: 'Google AI models, multimodal capabilities',
      },
      {
        name: 'LangChain',
        level: 3,
        icon: '🦜',
        color: '#1C3C3C',
        description: 'LLM orchestration, chains, agents framework',
      },
      {
        name: 'RAGs',
        level: 3,
      ...
      },
      {
        ...
        icon: '🤝',
        color: '#EC4899',
        description: 'Autonomous AI agents, tool use, workflows',
      },
      {
        name: 'MCP',
        level: 3,
        icon: '🔗',
        color: '#F59E0B',
        description: 'Model Context Protocol, AI integrations',
      },
      {
        name: 'AI Workflows',
        level: 3,
        icon: '⚡',
        color: '#8B5CF6',
        description: 'Automation, orchestration, AI-powered processes',
      },
      {
        name: 'n8n',
        level: 3,
        icon: '🔄',
        color: '#EA4B71',
        description: 'Workflow automation, integrations, no-code',
      },
      {
        name: 'Zapier',
        level: 3,
        icon: '⚙️',
        color: '#FF4A00',
        description: 'App integrations, automated workflows',
      },
      {
        name: 'Make.com',
        level: 3,
        icon: '🎯',
        color: '#6D00CC',
        description: 'Visual automation, complex workflows',
      },
    ],
  },
  {
...
export const skillCategories = {
  frontend: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'JavaScript', 'Bootstrap', 'Material UI', 'Shadcn UI'],
  backend: ['Node.js', 'GraphQL', 'PostgreSQL', 'MongoDB', 'Redis', 'Prisma', 'REST APIs', '.NET', 'C#'],
  devops: ['Docker', 'AWS', 'Kubernetes', 'CI/CD', 'Git'],
  ai: ['OpenAI SDK', 'Anthropic', 'Gemini', 'LangChain', 'RAGs', 'MCP', 'AI Workflows', 'AI Agents', 'n8n', 'Zapier', 'Make.com'],
  testing: ['Jest'],
  design: ['Figma'],
