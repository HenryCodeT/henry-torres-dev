      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            A selection of projects I've built - from e-commerce platforms to
            AI-powered tools and everything in between
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            { value: projects.filter(p => p.client).length, label: 'Clients Served', icon: '🤝' },
            { value: '100%', label: 'Success Rate', icon: '✅' },
            { value: '4+', label: 'Years Building', icon: '🚀' },
          ].map((stat, index) => (
            <motion.div
              key={stat.label}
