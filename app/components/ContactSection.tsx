              ...
              <div className="flex gap-4">
                {socialLinks.map((social) => (
                  <motion.a
                    ...
                    className={`p-4 text-muted-foreground ${social.color} bg-muted rounded-xl transition-all duration-200`}
...
function ContactInfoCard({
  ...
  const content = (
    <div className="flex items-start gap-4 p-6 bg-card-bg rounded-2xl shadow-md hover:shadow-lg transition-shadow">
